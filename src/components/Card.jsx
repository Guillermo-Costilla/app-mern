...
export default function Card({ city, image, country }) {
    return (
        <div className="flex justify-center items-center w-full">
            <div className="w-[400px] h-[500px] rounded-lg bg-cover bg-center shadow-2xl m-[30px] hover:-translate-y-1 hover:scale-110 duration-300" style={{ backgroundImage: `url(${image})` }}>
