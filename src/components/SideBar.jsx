        ...
        <div className='py-3 border-b-0 flex items-center bg-gray-900 shadow-2xl'>
            ...
            <div className='md:flex md:items-center md:px-7 w-[20%]'>
                <img
                    ...
                    alt="default photo"
                />
                <p className='md:max-lg:max-w-[30px] md:max-lg:pr-4 md:text-xl md:ml-1 font-semibold text-center items-center md:mr-10 text-gray-200'>{user ? user.name : defaultName}</p>
            </div>
