...
const Carousel = () => {
    ...
    return (
        <div id="carouselExampleCrossfade" className="relative w-5/6" data-te-carousel-init data-te-ride="carousel">
            ...
            <div className="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
                {images.map((image, index) => (
                    <div
                        ...
                        data-te-carousel-active={index === currentIndex}
                    >
                        <img src={image.src} className="block w-full bg-cover bg-center rounded-xl h-[600px]" alt={image.title} />
                    </div>
                ))}
            </div>
