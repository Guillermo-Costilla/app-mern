...
const Home = () => {
    ...
    return (
        <div className="flex flex-grow sm:max-lg:flex-col sm:max-lg:w-full">
            <div className="mx-auto w-1/2 sm:max-lg:w-full">
                ...
                <button className="text-white px-4 py-2 text-2xl font-bold ml-8 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:drop-shadow-xl duration-300">View More Cities</button>
            </div>
