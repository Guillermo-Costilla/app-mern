    ...
    return (
        <div className='w-full flex grow flex-col min-h-screen'>
            ...
            <div className='w-full flex m-auto justify-center'>
                ...
                <button onClick={handleSearch}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 ml-2">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                </svg>
                </button>
                <Link to="/create-city" className="ml-4 bg-blue-500 text-white p-2 rounded">+</Link>
            </div>
            <div className='flex flex-1 flex-wrap mx-auto items-center justify-center text-center w-1/2 lg:w-full'>

                {
                    cities?.length > 0
                        ...
                        )) : <h2 className='text-2xl font-bold text-center'>Sorry, no cities were found</h2>
                }
            </div>
        </div>
    );
